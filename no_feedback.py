...
logger = logging.getLogger('no-feedback')
...
def main():
    ...
    logger.info('Starting no-feedback with spec: %s, base URL: %s', openapi_spec_file, base_url)
...
if __name__ == "__main__":
    setup_logging('no-feedback', log_file='no-feedback.log')
    base_url = sys.argv[2]
    EPSILON = [0.1]
    ss = [None]
    key_matched = {}
